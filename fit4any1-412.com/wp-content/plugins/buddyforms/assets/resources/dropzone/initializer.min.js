...
else{jQuery("#"+t+"_label").text("Wrong Url Format")}};function checkURL(e){return(e.match(/\.(jpeg|jpg|gif|png)$/)!=null)};var uploadImplementation=uploadHandler();jQuery(document).ready(function(){uploadImplementation.init()});