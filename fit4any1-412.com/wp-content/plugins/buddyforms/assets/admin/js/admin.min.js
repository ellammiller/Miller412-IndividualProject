...
else{t=!1};return t};function buddyforms_validate_notifications_email(e){if(e){var r=jQuery(e).val();if(r){var t=buddyformsValidateMultiEmail(jQuery(e).val());if(!t){jQuery(e)[0].setCustomValidity('Invalid Email(s)');jQuery(e).addClass('bf-error')}
...
else{e('tr[id$="_captcha_v3_action"]').hide();e('tr[id$="_captcha_v3_score"]').hide();e('.bf_hide_captcha_v2_options').hide()}});e(document).on('click','.bf-ready-to-copy',function(t){t.preventDefault();t.stopPropagation();var r=e(this);if(r.is('input')){buddyformsCopyStringToClipboard(r.val())}
else{var a=e(this).closest('.accordion-heading-options'),o=a.parent().find('.accordion-body');o.removeClass('ui-accordion-content-active').hide();buddyformsCopyStringToClipboard(r.text());o.addClass('ui-accordion-content-active')};return!1})});