<form action="" method="post" class="calorie_calculator_form_us_units calorie_calculator_form" name="calorie_calculator_form_us_units">
	...
	<?php $object->calcalpro->get_calculator_field('height', 'bootstrap-general', array('unit' => 'usunit')); ?>
	<?php $object->calcalpro->get_calculator_field('weight', 'bootstrap-general', array('unit' => 'usunit')); ?>
